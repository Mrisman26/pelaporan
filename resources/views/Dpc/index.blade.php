                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped align-center">
                                                        <thead>
                                                            <tr class="text-center">
                                                                ...
                                                                <th class="bg-secondary"> Deskripsi </th>
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-danger btn-sm ml-1 mt-1" href="/deletepc/{{$kelompok3->idpc}}">
                                                                    ...
                                                                    <a class="btn btn-primary btn-sm ml-1 mt-1" href="/editpc/{{$kelompok3->idpc}}"> <svg
