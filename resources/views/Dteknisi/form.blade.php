                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-secondary">
                                    <h3 class="card-title">Form Tambah Data Teknisi</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        <form action="{{ url('submitt') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><input type="text" name="name" required placeholder="Masukan Nama Teknisi" class="form-control"></th>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <input class=" fs-2 form-control" type="text" name="level" required value="TEKNISI" readonly >
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th><label for="">
                                                    ...
                                                    <th><input type="emial" name="email" required placeholder="Masukan Nama Email" class="form-control"></th>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th><label for="exampleInputemail" class="form-label">Masukan Foto</label></th>
                                                ...
                                                <tr>
                                                    <th><button class="btn btn-primary btn-sm mb-3" type="submit">Tambah
                                                            Data</button>
                                                            <a class="btn btn-danger btn-sm mb-3" href="{{ url('/dteknisi') }}"> Kembali</a>
                                                        </th>
                                                </tr>
                                            </table>
                                        </form>
