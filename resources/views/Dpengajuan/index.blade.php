                                        ...
                                        <tbody class="align-middle">
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-warning btn-sm mt-1" href="/detailkerusakan/{{$kelompok3->idpengajuan}}">
                                                        <svg
                                                    ...
                                                    <a class="btn btn-danger btn-sm ml-1 mt-1" href="/deletep/{{$kelompok3->idpengajuan}}">
                                                    ...
                                                    <a class="btn btn-primary btn-sm ml-1 mt-1" href="/editp/{{$kelompok3->idpengajuan}}"> <svg
                                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
