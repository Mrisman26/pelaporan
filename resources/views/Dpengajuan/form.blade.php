                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-secondary">
                                    <center>
                                        <h3 class="card-title">AJUKAN PELAPORAN</h3>
                                    </center>
                                        ...
                                        <form action="{{ url('/submitke') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <select id='pc' name='namapc' class="form-control">
                                                            ...
                                                            @foreach($pc as $kerusakan)
                                                            <option value='{{ $kerusakan->idpc }}'>{{ $kerusakan->namapc }}</option>
                                                            @endforeach
                                                        </select>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th><input type="file" name="bukti_foto" class="form-control"></th>
                                                </tr>
                                                <tr>
                                                    <th><label for="exampleInputemail" class="form-label">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                    ...
                                                    <th>
                                                        <textarea type="text" name="deksripsi" class="form-control" rows="5"></textarea>
                                                    </th>
                                                </tr>
                                                <tr>
